...
const notifications = [
  ...
  },
  {
    id: 2,
    type: "recommendation",
    message: "Dr. Chen recommends a low-FODMAP diet to help manage high blood sugar symptoms",
    time: "1 week",
    ...
    <>
      <div className="space-y-4">
        {visibleNotifications.map((notification) => (
          <Card key={notification.id} className={`${notification.color} border`}>
        ...
        <DialogContent className="max-w-2xl h-[80vh] flex flex-col">
          ...
          <div className="flex-grow flex flex-col overflow-hidden">
            <div className="mb-4 grid grid-cols-2 gap-2">
              {selectedNotification?.suggestedQuestions.map((question, index) => (
                <Button
                  key={index}
                  variant="outline"
